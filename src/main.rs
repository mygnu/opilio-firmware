...
fn main() -> ! {
    ...
    let adc1 = Adc::adc1(dp.ADC1, &mut rcc.apb2, clocks);
    ...
    let pwm_timer2: PwmTimer2 =
        Timer::tim2(dp.TIM2, &clocks, &mut rcc.apb1)
    ...
    let pwm_timer3: PwmTimer3 = Timer::tim3(dp.TIM3, &clocks, &mut rcc.apb1)
    ...
    let pwm_input_timer: PwmInputTimer =
        Timer::tim4(dp.TIM4, &clocks, &mut rcc.apb1).pwm_input(
            pwm_input_pins,
            &mut afio.mapr,
            &mut dbg,
